        ...
        <>
            <div>
                <h1 style={{ fontFamily: 'cursive' + '', fontSize: '40' +'px', marginLeft:'30px' }}>
                    About Grow Garden 101
                </h1>

                <p style={{ fontFamily: 'Avenir' + '', fontSize: '20' + 'px', maxWidth: "800px", marginLeft:'60px', textIndent:'30px'}}>
                    Welcome to Grow Garden 101, your ultimate gardening companion! Whether you're a 
                    seasoned green thumb or just starting out with your very first seedling, Grow Garden 101 
                ...
                <p style={{ fontFamily: 'Avenir' + '', fontSize: '20' + 'px', maxWidth: "800px", marginLeft:'60px' , textIndent:'30px'}}>
                    At Grow Garden 101, we believe that gardening is more than just a hobby—it's a way to 
                ...
                <p style={{ fontFamily: 'Avenir' + '', fontSize: '20' + 'px', maxWidth: "800px", marginLeft:'60px', textIndent:'30px'}}>
                    ...
                    and triumphs. Let Grow Garden 101 inspire you to transform your outdoor space, nurture 
